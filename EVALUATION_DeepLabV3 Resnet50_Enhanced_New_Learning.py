...
from Model_DeepLabV3_Resnet50_Enhanced_New_Learning_rate import test_loader, TransformerSegmentationModel
...
model.load_state_dict(torch.load('DeepLabV3_Res50_New_Learning_rate_256.pth', map_location=device))
